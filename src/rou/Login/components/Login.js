...
import * as action from '/home/excellencetech/PollingApp/src/services/index.js'
...
export const Login = ({ children }) => (
  ...
  <RaisedButton onClick={(e)=>{e.preventDefault(); action.loginapifire()}} label="Login" primary={true} style={style} />
  </div>
  </MuiThemeProvider>
  </div>
  </div>
